...
$validSections = ['counter', 'scripts', 'navigation', 'progress', 'notifications', 'shared-data', 'lazy', 'content', 'data', 'defer', 'rehydrate', 'errors', 'event', 'event-bus', 'flash', 'link', 'modal', 'persistent', 'state', 'teleport', 'toggle', 'transition'];
