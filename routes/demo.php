...
$validSections = ['counter', 'scripts', 'navigation', 'progress', 'notifications', 'shared-data', 'lazy', 'content', 'data', 'defer', 'rehydrate', 'errors', 'event', 'flash', 'link', 'modal', 'state', 'teleport'];
