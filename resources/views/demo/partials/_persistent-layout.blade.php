...
<section class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8 border border-slate-100">
    <div class="flex items-center gap-3 mb-2">
        ...
        <h2 class="text-2xl font-semibold text-slate-800">Persistent Layout</h2>
    </div>
    <p class="text-slate-500 mb-6 ml-6">
        Keep elements like media players active during SPA navigation using <code class="bg-slate-100 px-1.5 py-0.5 rounded text-sm">&lt;x-accelade::persistent&gt;</code>.
    </p>
    ...
    <div class="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-slate-50 rounded-xl p-6 border border-slate-100">
            <h3 class="font-medium text-slate-700 mb-4 flex items-center gap-2">
                <span class="text-xs px-2 py-1 bg-rose-100 text-rose-700 rounded">Concept</span>
                How It Works
            </h3>
        ...
        <div class="bg-slate-50 rounded-xl p-6 border border-slate-100">
            <h3 class="font-medium text-slate-700 mb-4 flex items-center gap-2">
                <span class="text-xs px-2 py-1 bg-amber-100 text-amber-700 rounded">Use Cases</span>
                When to Use
            </h3>
    ...
    <!-- Live Example -->
    <div class="bg-gradient-to-r from-rose-50 to-pink-50 rounded-xl p-6 border border-rose-100 mb-6">
        <h3 class="font-medium text-slate-700 mb-4">Live Example</h3>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-lg p-4 border border-slate-200">
                <h4 class="text-sm font-medium text-slate-700 mb-2">Regular Element</h4>
                <p class="text-xs text-slate-500 mb-3">Re-renders on navigation</p>
                <x-accelade::data :default="['count' => 0]">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xs text-slate-400">Resets on navigation</span>
                    </div>
                </x-accelade::data>
            </div>
            ...
            <div class="bg-white rounded-lg p-4 border border-rose-200">
                <h4 class="text-sm font-medium text-rose-700 mb-2">Persistent Element</h4>
                <p class="text-xs text-rose-500 mb-3">Preserved across navigation</p>
        ...
        <p class="text-xs text-slate-500 mt-4">
            <strong>Try it:</strong> Increment both counters, then navigate to another section using the sidebar and come back.
    ...
    <div class="bg-slate-50 rounded-xl p-6 border border-slate-100 mb-6">
        <h3 class="font-medium text-slate-700 mb-4">Creating Custom Persistent Layouts</h3>
        <p class="text-sm text-slate-600 mb-4">
            For complex use cases, create a custom layout component by extending <code class="bg-slate-100 px-1 py-0.5 rounded text-xs">PersistentComponent</code>:
        </p>

        <div class="grid md:grid-cols-2 gap-4">
            <div class="bg-white rounded-lg p-4 border border-slate-200">
                <h4 class="text-sm font-medium text-slate-600 mb-2">1. Create PHP Component</h4>
                <pre class="text-xs text-slate-600 overflow-x-auto"><code>php artisan make:component VideoLayout
...
class VideoLayout extends PersistentComponent
{
    public function render()
    {
        return view('components.video-layout');
            ...
            <div class="bg-white rounded-lg p-4 border border-slate-200">
                <h4 class="text-sm font-medium text-slate-600 mb-2">2. Create Blade View</h4>
                <pre class="text-xs text-slate-600 overflow-x-auto"><code>&lt;!-- video-layout.blade.php --&gt;
&lt;div&gt;
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-amber-700">
                    Persistent elements require the same <code class="bg-amber-100 px-1 py-0.5 rounded text-xs">id</code> attribute
                    on both the source and destination pages. Navigation must use SPA links
                    (<code class="bg-amber-100 px-1 py-0.5 rounded text-xs">&lt;x-accelade::link&gt;</code>) for persistence to work.
                </p>
            </div>
        </div>
    </div>
